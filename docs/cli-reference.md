...
> Auto-generated 2026-09-19 from `fieldkit --help`. Do not edit manually.
...
Commands:
  ...
  run     Pick the oldest agent-ready issue and execute its brief.
...
Usage: fieldkit health run [OPTIONS]
  ...
  runner failures). Exits 1 on partial/fatal runner outcomes.
