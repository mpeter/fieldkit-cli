...
_EXPECTED_CONDITIONS = {
    ...
    "build": "github.event_name == 'push' || (github.event_name == 'workflow_dispatch' && needs.approval.result == 'skipped')",
    "attest": "github.event_name == 'push' || inputs.mode == 'testpypi'",
    "publish_testpypi": "github.event_name == 'workflow_dispatch' && inputs.mode == 'testpypi'",
    "publish_pypi": "github.event_name == 'push'",
    "github_release": "github.event_name == 'push'",
    _CONSUMER_JOB: "github.event_name == 'push'",
