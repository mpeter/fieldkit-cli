...
name: start
description: >
  You're setting up the AE OS workspace for the first time, or need to reinitialise it after
  ...
  "fresh install", "initialise fieldkit", "start from scratch", "set up AE OS",
